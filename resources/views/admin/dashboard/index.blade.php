@extends('layouts.admin.clientes.app')
...
@section('css')
    <link href="{{ asset('/admin/css/apexcharts.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('/admin/css/light/dash_1.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('/admin/css/dark/dash_1.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('scripts')
    <script src="{{ asset('/admin/js/apexcharts.min.js') }}?{{ uniqid() }}"></script>
    <script src="{{ asset('/admin/js/dash_1.js') }}?{{ uniqid() }}"></script>
