    ...
    <div class="page-header text-blue-d2">
        ...
        <div class="page-tools">
            <div class="action-buttons">
                <a class="btn bg-white btn-light mx-1px text-95"  onclick="imprimir()" data-title="Imprimir">
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-10 offset-lg-1">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div>
                            <span class="text-sm text-grey-m2 align-middle">Corte de:</span>
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Fecha:</span>
                                {{$date}}</div>
                ...
                <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                    ...
                    <tbody class="text-95 text-secondary-d3">
                        ...
                        <tr>
                            ...
                            <td>{{$payment->translateMethod()}}</td>
                            @if (is_null($payment->saleOrder))
                            <td>Sin asignar</td>
                            @else
                            <td>{{$payment->saleOrder->number}}</td>
                            @endif
...
<hr />
                            <div class="row my-2">
                                ...
                                <div class="col-5">
                                    <span class="text-120 text-secondary-d1">${{$total_cash}}</span>
                                </div>
                            </div>
