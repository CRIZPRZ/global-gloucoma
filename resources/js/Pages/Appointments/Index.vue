	...
	<div class="row  ">
		<div class="col-md-12">
            <div class="d-flex justify-content-end">
                <div v-if="can('create quotes')" class="seperator-header  mx-2  mt-3">
	                        ...
	                        <tr v-for="appointment in appointments" :key="appointment.id">
	                        	...
	                        	<td class="text-center" style="font-size: 16px;">
				                    <div class="action-btns">
				                        <Link v-if="can('update quotes')" :href="route('admin.appointmentsTracing.index', appointment.id)" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Seguimiento" >
